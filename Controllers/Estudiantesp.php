<?php 
	...
	class Estudiantesp extends Controllers{
		...
		public function Estudiantesp()
		{
			...
			$data['page_functions_js'] = "functions_estudiantesp.js";
			$this->views->getView($this,"estudiantesp",$data);
		}
